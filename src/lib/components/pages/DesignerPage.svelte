...
<section
  class="page-backdrop relative flex min-h-[100svh] w-full flex-col gap-6 overflow-hidden p-7"
...
>
  <div class="relative z-20 grid min-h-0 flex-1 grid-cols-[minmax(320px,0.94fr)_minmax(360px,1.06fr)] gap-5 max-lg:grid-cols-1">
    <section
      class="relative min-h-[580px] overflow-hidden rounded-lg border border-[rgba(38,66,56,0.16)] bg-[#13211d] shadow-[var(--shadow)] backdrop-blur-[18px]"
    ...
    <section
      class="flex min-h-[580px] flex-col overflow-hidden rounded-lg border border-[rgba(38,66,56,0.16)] bg-[rgba(255,250,242,0.78)] shadow-[var(--shadow)] backdrop-blur-[18px]"
    ...
    >
      ...
      <div
        class="grid grid-cols-3 gap-3.5 border-t border-[rgba(38,66,56,0.14)] bg-[rgba(255,250,242,0.84)] p-5 max-sm:grid-cols-1"
